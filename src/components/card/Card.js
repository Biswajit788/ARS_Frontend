                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <p><strong>E-Pocurement Data System (ePDS)</strong> is a central data repository system of all the procurement made within an Organization irrespective of the department.
                            It is an initiative from the IT Department, Corporate HQ, Shillong to make the retrieval of data at the easiest way to meet the Organization needs as an when required.
                        </p>
